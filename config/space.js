...
export async function uploadObject(key, file) {
    ...
    const client = new S3Client({
        endpoint: `https://${process.env.S3REGION}.digitaloceanspaces.com`, // Find your endpoint in the control panel, under Settings. Prepend "https://".
        forcePathStyle: false,
        region: process.env.S3REGION, // Must be "us-east-1" when creating new Spaces. Otherwise, use the region in your endpoint (e.g. nyc3).
        credentials: {
...
export async function updateObject(createKey, file, deleteKey) {
