...
addressRoutes
  .route("/get-carrier-charge")
  .post(protectForCustomer, getCarrierCharge);
addressRoutes
  .route("/check-address-verification")
  .post(protectForCustomer, checkAddressValid);

//Easy-post tracking.
addressRoutes
  .route("/tracking-shipping/easypost-webhook")
